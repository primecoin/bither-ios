...
#define TX_MIN_OUTPUT_AMOUNT 1000000llu     // no tx output can be below this amount (or it won't be relayed)
...
#else
#define BITCOIN_STANDARD_PORT          9911
...
#define PRIMERI_VERSION @"1.6.5"
#define PRIMERI_NAME @"Bither"
#define USERAGENT [NSString stringWithFormat:@"/Bither:%@/", PRIMERI_VERSION]
...
#define MIN_PROTO_VERSION  70015 // peers earlier than this protocol version not supported (SPV mode required)
...
#else // main net
#define GENESIS_BLOCK_HASH @"963d17ba4dc753138078a2f56afb3af9674e2546822badff26837db9a0152106".hexToData.reverse

//#define GENESIS_BLOCK_HASH @"062115a0b97d8326ffad2b8246254e67f93afb6af5a278801353c74dba173d96".hexToData.reverse
...
//交易数据同步
#define BTTranscationManagerSyncProgressNotification @"BTPeerManagerSyncProgressNotification"
