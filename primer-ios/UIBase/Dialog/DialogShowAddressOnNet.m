...
- (instancetype)initWithAddress:(NSString *)address {
    ...
    [array addObject:[[Action alloc] initWithName:NSLocalizedString(@"View on Bchain.info", nil) target:nil andSelector:@selector(showOnBlockchain)]];
...
- (void)showOnBlockchain {
    NSString *url = [NSString stringWithFormat:@"https://bchain.info/XPM/addr/%@", _address];
